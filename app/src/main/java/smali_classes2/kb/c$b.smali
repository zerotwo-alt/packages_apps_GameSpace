...
.method public synthetic constructor <init>(Lkb/c$a;)V
    ...
    .line 2
    invoke-direct {p0}, Lkb/c$b;-><init>()V
...
.method public a(Ls9/b;Ljava/lang/Object;)Laa/a;
    ...
    invoke-static {p2}, Lkb/e;->b(Lj9/s;)Lua/c;

    move-result-object p2

    new-instance v0, Lua/e;

    invoke-direct {v0, p2, p0}, Lua/e;-><init>(Lua/c;[B)V
    :try_end_0
    ...
    invoke-static {p1}, Lkb/e;->b(Lj9/s;)Lua/c;

    move-result-object p1

    new-instance p2, Lua/e;

    invoke-direct {p2, p1, p0}, Lua/e;-><init>(Lua/c;[B)V

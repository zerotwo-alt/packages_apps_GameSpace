...
.method public synthetic constructor <init>(Lkb/c$a;)V
    ...
    .line 2
    invoke-direct {p0}, Lkb/c$g;-><init>()V
...
.method public a(Ls9/b;Ljava/lang/Object;)Laa/a;
    ...
    invoke-static {p2}, Lkb/e;->m(Lj9/s;)Lab/d;

    move-result-object p2

    new-instance v0, Lab/f;

    invoke-direct {v0, p2, p0}, Lab/f;-><init>(Lab/d;[B)V
    :try_end_0
    ...
    invoke-static {p1}, Lkb/e;->m(Lj9/s;)Lab/d;

    move-result-object p1

    new-instance p2, Lab/f;

    invoke-direct {p2, p1, p0}, Lab/f;-><init>(Lab/d;[B)V

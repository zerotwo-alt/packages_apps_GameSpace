...
# direct methods
.method public constructor <init>(I[B[B[BLta/d;)V
    .locals 0
    ...
    iput-object p2, p0, Lta/c;->b:[B

    iput-object p3, p0, Lta/c;->c:[B

    iput-object p4, p0, Lta/c;->d:[B

    iput-object p5, p0, Lta/c;->e:Lta/d;
...
.method public constructor <init>(Lj9/z;)V
    ...
    invoke-static {p1}, Lta/d;->l(Ljava/lang/Object;)Lta/d;
...
.method public static m(Ljava/lang/Object;)Lta/c;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lta/c;-><init>(Lj9/z;)V
...
.method public b()Lj9/w;
    ...
    iget-object v2, p0, Lta/c;->d:[B

    invoke-direct {v1, v2}, Lj9/k1;-><init>([B)V

    invoke-virtual {v0, v1}, Lj9/f;->a(Lj9/e;)V

    iget-object p0, p0, Lta/c;->e:Lta/d;

    if-eqz p0, :cond_0

    new-instance v1, Lta/d;

    invoke-virtual {p0}, Lta/d;->k()[B

    move-result-object p0

    invoke-direct {v1, p0}, Lta/d;-><init>([B)V

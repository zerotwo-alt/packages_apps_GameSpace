...
.method public static synthetic c(Landroidx/window/embedding/EmbeddingAdapter;Lh8/l;Landroidx/window/extensions/embedding/SplitAttributesCalculatorParams;)Landroidx/window/extensions/embedding/SplitAttributes;
    .locals 0

    invoke-static {p0, p1, p2}, Landroidx/window/embedding/EmbeddingAdapter;->translateSplitAttributesCalculator$lambda$0(Landroidx/window/embedding/EmbeddingAdapter;Lh8/l;Landroidx/window/extensions/embedding/SplitAttributesCalculatorParams;)Landroidx/window/extensions/embedding/SplitAttributes;
...
.method private final translateActivityRule(Landroidx/window/embedding/ActivityRule;Ljava/lang/Class;)Landroidx/window/extensions/embedding/ActivityRule;
    ...
    invoke-direct {p0, p1}, Landroidx/window/embedding/e;-><init>(Landroidx/window/embedding/ActivityRule;)V

    new-instance p2, Landroidx/window/embedding/f;

    invoke-direct {p2, p1}, Landroidx/window/embedding/f;-><init>(Landroidx/window/embedding/ActivityRule;)V
...
.method private static final translateSplitAttributesCalculator$lambda$0(Landroidx/window/embedding/EmbeddingAdapter;Lh8/l;Landroidx/window/extensions/embedding/SplitAttributesCalculatorParams;)Landroidx/window/extensions/embedding/SplitAttributes;
    .locals 1
...
.method public final translate(Landroid/content/Context;Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-static {p2, v2}, Lkotlin/collections/o;->t(Ljava/lang/Iterable;I)I
...
.method public final translateSplitAttributesCalculator(Lh8/l;)Landroidx/window/extensions/core/util/function/Function;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p0, p1}, Landroidx/window/embedding/d;-><init>(Landroidx/window/embedding/EmbeddingAdapter;Lh8/l;)V

...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lp/h;->a:Ljava/lang/ThreadLocal;

    new-instance v0, Lp/h$b;

    invoke-direct {v0}, Lp/h$b;-><init>()V

    sput-object v0, Lp/h;->b:Ljava/lang/ThreadLocal;

    new-instance v0, Lp/h$c;

    invoke-direct {v0}, Lp/h$c;-><init>()V

    sput-object v0, Lp/h;->c:Ljava/lang/ThreadLocal;

    new-instance v0, Lp/h$d;

    invoke-direct {v0}, Lp/h$d;-><init>()V

    sput-object v0, Lp/h;->d:Ljava/lang/ThreadLocal;
...
.method public static a(Landroid/graphics/Path;FFF)V
    ...
    sget-object v1, Lp/h;->a:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Lp/h;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v3, Lp/h;->c:Ljava/lang/ThreadLocal;
    ...
    invoke-static {v5, v4}, Lp/g;->f(FF)I

    move-result p2

    int-to-float v5, p2

    invoke-static {p1, v4}, Lp/g;->f(FF)I
...
.method public static b(Landroid/graphics/Path;Lf/u;)V
    .locals 3

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lf/u;->k()Z
    ...
    invoke-virtual {p1}, Lf/u;->h()Lg/a;

    move-result-object p1

    check-cast p1, Lg/d;

    invoke-virtual {p1}, Lg/d;->p()F
    ...
    invoke-static {p0, v0, v1, p1}, Lp/h;->a(Landroid/graphics/Path;FFF)V
...
.method public static g(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Lp/h;->d:Ljava/lang/ThreadLocal;
...
.method public static m(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    ...
    invoke-static {p0, p1, p2, v0}, Lp/h;->n(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
